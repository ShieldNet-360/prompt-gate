...
func merge(defaults, override Config) Config {
	...
	if override.AlertWebhookURL != "" {
		out.AlertWebhookURL = override.AlertWebhookURL
	}
	if override.AlertThresholdBlocks != 0 {
		out.AlertThresholdBlocks = override.AlertThresholdBlocks
	}
	if override.AlertInterval != 0 {
		out.AlertInterval = override.AlertInterval
	}
